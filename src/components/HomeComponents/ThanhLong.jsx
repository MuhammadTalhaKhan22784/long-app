...
const ThanhLong = () => {
  const commentData = [
    ...
    {
      name: "Long",
      text: "Maecenas rhoncus massa vitae dignissim sagittis. Praesent in dapibus dui. Nam ac magna vel lorem elementum laoreet in non",
    },
  ];
  return (
    <>
      <div className="post-open-box mt_50">
        <h3 className="head-sub-text">Thanh Long</h3>
        <span className="gmail-text">long@gmail.com</span>
        <p className="color-three mt_30">
          Suspendisse imperdiet, magna et scelerisque placerat, est lorem
          iaculis odio, placerat faucibus libero justo quis libero. Aliquam
          consequat et risus id porttitor. Etiam varius ut odio eget auctor.
          Donec feugiat pulvinar tincidunt. Vestibulum interdum posuere nisi,
          vel vehicula felis ultricies nec. Morbi consectetur efficitur tellus,
          vitae posuere{" "}
        </p>
