...
const CommentCard = () => {
  const commentCardData = [
    {
      heading: "Thanh Long",
      mail: "long@gmail.com",
      para: "Suspendisse imperdiet, magna et scelerisque placerat, est lorem iaculis odio, placerat faucibus libero justo quis libero. Aliquam consequat et risus id porttitor. Etiam varius ut odio eget auctor. Donec feugiat pulvinar tincidunt. Vestibulum interdum posuere nisi, vel vehicula felis ultricies nec. Morbi consectetur efficitur tellus, vitae posuere",
      like: "148k",
      comments: [
        {
          name: "Phuong",
          commentText:
            "Suspendisse imperdiet, magna et scelerisque placerat, est lorem iaculis odio, placerat faucibus libero",
        },
        {
          name: "Long",
          commentText:
            "Maecenas rhoncus massa vitae dignissim sagittis. Praesent in dapibus dui. Nam ac magna vel lorem elementum laoreet in non",
        },
      ],
    },
    ...
    {
      heading: "Hue Phuong",
      mail: "Huephuong@gmail.com",
      para: "Nullam finibus eleifend mi, eget finibus risus. Donec dictum cursus vestibulum. Interdum et malesuada fames ac ante ipsum primis in faucibus. Praesent luctus sodales lorem. Vestibulum et facilisis tellus. Nam gravida pellentesque dolor id blandit. Vivamus volutpat quam at velit ultricies, accumsan lobortis dui cursus.",
      like: "148k",
      comments: [
        {
          name: "Long",
          commentText:
            "Nullam finibus eleifend mi, eget finibus risus. Donec dictum cursus vestibulum. Interdum et malesuada fames ac ante ipsum primis in faucibus. Praesent luctus sodales lorem. Vestibulum et facilisis tellus. Nam gravida pellentesque dolor id blandit. Vivamus volutpat quam at velit ultricies, accumsan lobortis dui cursus.",
        },
      ],
    },
    {
      ...
      comments: [
        ...
        },
        {
          name: "Phuong",
          commentText:
            "Phasellus sed euismod magna, vel rutrum turpis. Nulla facilisi. Nullam ac augue vel ante cursus aliquam sed et lectus.",
        },
      ],
    },
  ];
  ...
  return (
    <>
      {commentCardData.map((data, index) => {
        return (
          <div key={index} className="post-open-box mt_50">
            <h3 className="head-sub-text">{data.heading}</h3>
            <span className="gmail-text">{data.mail}</span>
            <p className="color-three mt_30">{data.para} </p>
            ...
            {data.comments.map((val, index) => {
              return (
                <div key={index} className="comment-reply mt_25">
                  <h3 className="head-sub-text">{val.name}</h3>
                  <p>{val.commentText}</p>
                </div>
              );
            })}
