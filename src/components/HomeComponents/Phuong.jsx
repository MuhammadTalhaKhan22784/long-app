...
const Phuong = () => {
  const commentData = [
    ...
    {
      name: "Phuong",
      text: "Phasellus sed euismod magna, vel rutrum turpis. Nulla facilisi. Nullam ac augue vel ante cursus aliquam sed et lectus.",
    },
  ];
  return (
    <>
      <div className="post-open-box mt_30">
        <h3 className="head-sub-text">Testing</h3>
        <span className="gmail-text">testing@gmail.com</span>
